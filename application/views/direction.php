...
<div class="container-fluid">
	<div class="row-fluid">
		<div class="span4">
			 <button onclick="javascript:location.href='/facebook/groupindex'" class="btn btn-primary btn-large btn-block" type="button">社团消息发布</button>
		</div>
		<div class="span4">
			 <button onclick="javascript:location.href='/facebook/addfriends'" class="btn btn-block btn-large btn-primary" type="button">添加朋友</button>
		</div>
		<div class="span4">
			 <button onclick="javascript:location.href='/facebook/suggestto'" class="btn btn-primary btn-large btn-block" type="button">推荐朋友</button>
		</div>
	</div>
</div>
</body>
